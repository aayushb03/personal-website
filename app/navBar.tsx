...
export default function NavBar() {
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    setCurrentPage(latest!= 1 ? Math.floor(latest * pages.length) : pages.length - 1);
  })
  ...
  const socials = [
    // GitHub:
    {
      ...
      link: "https://github.com/aayushb03"
    },
    // LinkedIn:
    {
      paths: [
      ...
      link: "https://www.linkedin.com/in/aayush-bharadwaj/"
    },
    // Email:
    {
      paths: [
        "M20 4C21.6569 4 23 5.34315 23 7V17C23 18.6569 21.6569 20 20 20H4C2.34315 20 1 18.6569 1 17V7C1 5.34315 2.34315 4 4 4H20ZM19.2529 6H4.74718L11.3804 11.2367C11.7437 11.5236 12.2563 11.5236 12.6197 11.2367L19.2529 6ZM3 7.1688V17C3 17.5523 3.44772 18 4 18H20C20.5523 18 21 17.5523 21 17V7.16882L13.8589 12.8065C12.769 13.667 11.231 13.667 10.1411 12.8065L3 7.1688Z"
      ],
      link: "mailto:abbharadwaj@wisc.edu"
    }
  ];
          ...
          <div className={"flex gap-8"}>
            {pages.map((page, i) => (
              <Link to={page.link} smooth duration={500} className={"flex h-full justify-center items-center cursor-pointer px-2 py-1 rounded-md relative duration-300 ease-in"} key={i}>
                ...
                {i === currentPage && (
                  <motion.div
                    className="absolute bottom-0 left-0 w-full h-1 rounded-lg -z-10 bg-app-red"
                    layoutId="navbar"
                    aria-hidden="true"
                    style={{
                      width: "100%",
