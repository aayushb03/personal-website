  ...
  const projects = [
    {
      ...
      paragraphs: [
        ...
        <span key={1}>We were also featured in 3 prominent Madison publications, including <a className={"text-blue-500 underline cursor-none"} href={"https://captimes.com/news/education/uw-madison-students-create-madhousing-dorm-review-website/article_e7e718f8-2eb3-550b-8f00-87a3aaef63e8.html"} target="_blank">The Cap Times</a>, <a className={"text-blue-500 underline cursor-none"} href={"https://www.dailycardinal.com/article/2023/02/madhousing-helps-make-dorm-selection-easier-for-incoming-students"} target="_blank">The Daily Cardinal</a>, and <a className={"text-blue-500 underline cursor-none"} href={"https://badgerherald.com/news/2023/02/14/uw-students-create-website-to-review-residence-halls/"} target="_blank">The Badger Herald</a>, along with being featured by <a className={"text-blue-500 underline cursor-none"} href={"https://uwalumni.com/news/raving-residence-hall-reviews/"} target="_blank">The UW-Madison Alumni Network</a>.</span>,
